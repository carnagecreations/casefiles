  ...
  useEffect(() => {
    const unsubs = [
      ...
      syncDoc<PricingSettings>('settings/pricing', DEFAULT_PRICING_SETTINGS, (loaded) => {
        ...
        // email field, write it in once so Shiann doesn't have to re-type it.
