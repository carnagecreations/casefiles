            ...
            <div className="p-5 space-y-3">
              ...
              <div>
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-xs text-slate-700 leading-relaxed font-sans select-all">
                  {`Hey! It's ${shareReferralClient.name}. I use Clean Convictions for our home cleaning in Yuma and they do an exceptional job. Use my link to get $25 OFF your first clean: https://cleanconvictions.com/book?rc=${shareReferralClient.referralCode || generateReferralCode(shareReferralClient.name, shareReferralClient.phone)} — or call/text (928) 555-0100.`}
                </div>
              </div>
            </div>
